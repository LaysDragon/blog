...
var (
	commentDBTypes = map[string]string{`ID`: `integer`, `CreatedDate`: `timestamp with time zone`, `PostID`: `integer`, `Email`: `character varying`, `Name`: `character varying`, `Content`: `text`}
	_              = bytes.MinRead
)
